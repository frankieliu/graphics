...
function drawTex(gl, textureInfo) {
  ...
  var drawInfo = {
    x: 0.5 * gl.canvas.width,
    y: 0.5 * gl.canvas.height,
    dx: Math.random() > 0.5 ? -1 : 1,
    dy: Math.random() > 0.5 ? -1 : 1,
    xScale: 0.5 * 0.25 + 0.25,
    yScale: 0.5 * 0.25 + 0.25,
    offX: 0.5 * 0.75,
    offY: 0.5 * 0.75,
    textureInfo: textureInfo,
  };
  drawInfo.width = 0.5 * (1 - drawInfo.offX);
  drawInfo.height = 0.5 * (1 - drawInfo.offY);
