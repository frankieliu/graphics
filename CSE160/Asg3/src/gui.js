...
function setProjectionMatrix() {
  const projMatrix = new Matrix4().setIdentity();
  globals.gl.uniformMatrix4fv(globals.program[0].u_ProjectionMatrix,
    false, projMatrix.elements);
}

function setViewMatrix() {
  const viewMatrix = new Matrix4().setIdentity();
  globals.gl.uniformMatrix4fv(globals.program[0].u_ViewMatrix,
